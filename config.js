...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~be44f9c9e039e8d00b475a6eabdc5f0a:4948784b58395064636b383d',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝚸𝚫𝐊𝐘 𝚩𝚯𝚻',
    ...
    LANGUAGE: process.env.LANGUAGE || 'italian',
    DEBUG: DEBUG,
